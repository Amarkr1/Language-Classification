...
#if(select==1):
#    clf = MultinomialNB()
#    clf.fit(X_train_tfidf_select, Y_train)
#    print ('Multinomial Nb(selected):', clf.score(X_val_tfidf_select,Y_val))
#    predictions = clf.predict(X_test_tfidf_select)
#    writeOut("MultiNB_selected",predictions,writeCode)
#    
#    
#    
#    #--------------------------------------------
...
#    clf.fit(X_train_tfidf_select, Y_train)
#    #clf.fit(X_train_tfidf, Y_train)
#    print ('Logistic Regression(selected): ', clf.score(X_val_tfidf_select,Y_val))
#    predictions = clf.predict(X_test_tfidf_select)
#    writeOut("LR_selected",predictions,writeCode)
#    
#    #--------------------------------------------
#    
#    clf = svm.LinearSVC()
#    clf.fit(X_train_tfidf_select, Y_train)
#    #clf.fit(X_train_tfidf, Y_train)
#    print ('SVM(selected): ', clf.score(X_val_tfidf_select,Y_val))
#    predictions = clf.predict(X_test_tfidf_select)
#    writeOut("SVM_selected",predictions,writeCode)
#    
#    
#    #--------------------------------------------
#    
...
#    clf.fit(X_train_tfidf_select, Y_train)
#    #clf.fit(X_train_tfidf, Y_train)
#    print ('LDA(selected): ', clf.score(X_val_tfidf_select,Y_val))
#    predictions = clf.predict(X_test_tfidf_select)
#    writeOut("LDA_selected",predictions,writeCode)
#    
#    
#    
#    #--------------------------------------------
...
#    clf.fit(X_train_tfidf_select, Y_train)
#    #clf.fit(X_train_tfidf, Y_train)
#    print ('RF(selected): ', clf.score(X_val_tfidf_select,Y_val))
#    predictions = clf.predict(X_test_tfidf_select)
#    writeOut("RF_selected",predictions,writeCode)
#    
